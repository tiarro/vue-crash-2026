...
// Need to read the URL? Use route : information about where you are
const route = useRoute();
// Need to change the URL? Use router : tool to change where you are
      ...
      <div class="grid grid-cols-1 md:grid-cols-[70%_28%] w-full gap-6">
        ...
        <aside>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <p class="my-2">{{ state.jobs.company.description }}</p>
